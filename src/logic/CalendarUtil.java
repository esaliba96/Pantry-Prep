...
public class CalendarUtil {
   ...
   public static Calendar getOffsetDate(Calendar c, int offSet){
      ...
      else if (dayOfMonth > c.getActualMaximum(Calendar.DAY_OF_MONTH)){
         month++;
         if (month > 12){
            year++;
            month = 1;
   ...
   static String numMonthToString(int num){
      switch(num){
   ...
   static String numWeekToString(int num){
      switch (num){
   ...
   static boolean compareDates(Calendar a,Calendar b){
